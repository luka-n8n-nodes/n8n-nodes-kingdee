...
export class Kingdee implements INodeType {
	description: INodeTypeDescription = {
		...
		version: [1],
		defaultVersion: 1,
		description: '金蝶云星空 WebAPI 集成，支持多种金蝶业务功能',
		defaults: {
			name: '金蝶云星空',
		},
		usableAsTool: true,
		...
		credentials: [
			{
				name: Credentials.KingdeeAppAuthApi,
				displayName: '应用授权凭证（推荐）',
				required: true,
				displayOptions: {
					show: {
						authentication: [Credentials.KingdeeAppAuthApi],
					},
				},
			},
			{
				name: Credentials.KingdeePasswordApi,
				displayName: '账户密码凭证（已废弃）',
				required: true,
				displayOptions: {
					show: {
						authentication: [Credentials.KingdeePasswordApi],
					},
				},
			},
		],
		properties: [
			{
				...
				options: [
					{
						name: '应用授权（推荐）',
						value: Credentials.KingdeeAppAuthApi,
					},
					{
						name: '账户密码（已废弃）',
						value: Credentials.KingdeePasswordApi,
					},
				],
				default: Credentials.KingdeeAppAuthApi,
			},
