...
const operation: ResourceOperations = {
	...
	options: [
		...
		} as INodeProperties,
		{
			...
			description: '物料编码 FNumber，多个编码用逗号分隔，如：No1,No2,No3',
		} as INodeProperties,
		{
			displayName: '物料内码',
			name: 'ids',
			...
			description: '物料表单内码 FID，多个内码用逗号分隔，如：100001,100002,100003',
		} as INodeProperties,
		{
			displayName: '创建者组织内码',
			name: 'createOrgId',
